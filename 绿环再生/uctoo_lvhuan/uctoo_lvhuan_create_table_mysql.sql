CREATE TABLE `accoding_sell_snapshot` (
  ...
  `sell_qty` decimal(10,2) DEFAULT NULL COMMENT '销售量',
  `sell_amount` decimal(10,2) DEFAULT NULL COMMENT '销售额',
  `start_price` decimal(10,2) DEFAULT NULL COMMENT '月初价',
  `new_price` decimal(10,2) DEFAULT NULL COMMENT '最新价',
  `avg_price` decimal(10,2) DEFAULT NULL COMMENT '平均价',
  `last_price` decimal(10,2) DEFAULT NULL COMMENT '最终价',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updata_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='销售月结存数据（月、星期、年、季度）';
CREATE TABLE `accoding_stock_history` (
  `FRelateBrID` int(11) NOT NULL COMMENT '分部id',
  `FStockID` varchar(20) DEFAULT NULL COMMENT '仓库id',
  `FItemID` int(11) DEFAULT NULL COMMENT '废料id',
  `FDCQty` decimal(10,1) DEFAULT NULL,
  `FSCQty` decimal(10,1) DEFAULT NULL,
  `FdifQty` int(11) DEFAULT NULL,
  `FDCTime` datetime DEFAULT NULL
...
CREATE TABLE `accoding_stock_snapshot` (
  `time_dims` varchar(20) NOT NULL DEFAULT '0' COMMENT '时间维度',
  `time_val` varchar(20) NOT NULL COMMENT '时间数值',
  ...
  `lastPrice` decimal(10,2) DEFAULT '0.00' COMMENT '最新价',
  ...
  KEY `idx_time` (`time_dims`,`time_val`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='仓库的出入库的结存数据（月、星期、年、季度）';
...
CREATE TABLE `bal_close_accounts` (
  `FBillInterID` int(11) NOT NULL COMMENT '顺序号',
  `FRelateBrID` int(11) NOT NULL COMMENT '分部内码',
  `FYear` int(11) NOT NULL COMMENT '会计年度',
  `FPeriod` int(11) NOT NULL COMMENT '会计期间',
  `FStockID` int(11) NOT NULL COMMENT '库房内码',
  `FItemID` int(11) NOT NULL COMMENT '商品内码',
  `FBatchNo` int(11) NOT NULL COMMENT '批号',
  `FBegQty` int(11) NOT NULL COMMENT '期初结存数量',
  `FReceive` int(11) NOT NULL COMMENT '本期收入数量',
  `FSend` int(11) NOT NULL COMMENT '本期发出数量',
  `FYtdReceive` int(11) NOT NULL COMMENT '本年收入数量',
  `FYtdSend` int(11) NOT NULL COMMENT '本年发出数量',
  `FEndQty` int(11) NOT NULL COMMENT '期末结存数量',
  `FBegBal` int(11) NOT NULL COMMENT '期初结存金额',
  `FDebit` int(11) NOT NULL COMMENT '本期收入金额',
  `FCredit` int(11) NOT NULL COMMENT '本期发出金额',
  `FYtdDebit` int(11) NOT NULL COMMENT '本年收入金额',
  `FYtdCredit` int(11) NOT NULL COMMENT '本年发出金额',
  `FEndBal` int(11) NOT NULL COMMENT '期末结存金额'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `cut_customer_sevrinfo` (
  ...
  `introduce_en` varchar(500) NOT NULL COMMENT '英文介绍',
  `img` text NOT NULL COMMENT '个人头像地址',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
CREATE TABLE `datawall_topcate` (
  `FRelateBrID` int(10) NOT NULL,
  `FItemID` int(10) NOT NULL,
...
CREATE TABLE `dingtalk_book_dep_info` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `dep_id` (`dep_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='通讯录的部门表';
CREATE TABLE `dingtalk_book_user_info` (
  `userid` varchar(50) NOT NULL COMMENT '员工的userid',
  `unionid` varchar(50) DEFAULT NULL COMMENT '员工在当前开发者企业账号范围内的唯一标识。',
  `wechat_id` varchar(50) DEFAULT NULL COMMENT '员工企业微信id',
  `admin_id_group` varchar(50) NOT NULL DEFAULT '0' COMMENT '员工admin_id组',
  `dept_id` varchar(100) NOT NULL COMMENT '部门id',
  `name` varchar(20) DEFAULT NULL COMMENT '员工的姓名',
  `mobile` varchar(11) DEFAULT NULL COMMENT '员工的手机号',
  `user_data` varchar(4096) DEFAULT NULL COMMENT '员工的json数据',
  `state` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态: 0--正常使用  1--离职',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`userid`) USING BTREE,
  UNIQUE KEY `unionid` (`unionid`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='钉钉的通讯录用户的信息';
...
CREATE TABLE `dingtalk_process_log` (
  ...
  `remark` text NOT NULL COMMENT '审批原因说明',
...
CREATE TABLE `dingtalk_visual_dept_num` (
  ...
  `dept_child_id` varchar(10000) DEFAULT NULL COMMENT '子部门的钉钉id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='绿环固废信息化管理平台---可视化大数据---钉钉部门成员数量表';
...
CREATE TABLE `performance_result_admin` (
  ...
  `varDaily` json DEFAULT NULL COMMENT '日变动',
...
CREATE TABLE `qc` (
  ...
  `cus_type` varchar(10) NOT NULL DEFAULT '',
...
CREATE TABLE `save_sellimit` (
  `FStockID` varchar(12) DEFAULT NULL,
  `FItemID` int(10) unsigned NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `tool_distribute_detail` (
  ...
  `receivePersonID` int(10) NOT NULL COMMENT '接收人ERP_ID',
...
CREATE TABLE `tool_distribute_main` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sendPersonID` varchar(10) NOT NULL COMMENT '发送人ID',
...
CREATE TABLE `tool_transorder` (
  `orderCode` varchar(11) NOT NULL COMMENT '联单编码',
  `customer` varchar(20) NOT NULL COMMENT '客户名称',
  `area` varchar(20) NOT NULL COMMENT '行政区划名称',
  `areaCode` varchar(4) NOT NULL COMMENT '行政区划码',
  `cateCode` varchar(2) NOT NULL COMMENT '固废编码',
  `code` int(8) NOT NULL COMMENT '顺序号',
...
CREATE TABLE `trans_assist_table` (
  ...
  KEY `FTranType` (`FTranType`,`FItemID`,`FDCTime`) USING BTREE,
  KEY `trans_assist_t_idx_001` (`FinterID`,`FTranType`,`FItemID`) USING BTREE,
  KEY `trans_assist_t_idx_003` (`FItemID`,`FSourceInterId`,`FinterID`,`FTranType`) USING BTREE,
  KEY `trans_assist_t_idx_004` (`value_type`) USING BTREE,
  KEY `trans_assist_t_idx_005` (`FTranType`,`disposal_way`,`FDCTime`,`red_ink_time`,`FinterID`) USING BTREE,
  KEY `trans_assist_t_idx_006` (`FinterID`,`FTranType`,`disposal_way`,`FDCTime`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trans_constitute_forcustomer_table` (
  ...
  `parent_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '二级分类ID',
  `FQty` double(19,2) DEFAULT NULL COMMENT '重量',
  `carbon_parm` float NOT NULL DEFAULT '0' COMMENT '碳减排参数',
  KEY `FRelateBrID` (`FRelateBrID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trans_daily_sor_table` (
  `FRelateBrID` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '分部ID',
  `FInterID` varchar(11) DEFAULT NULL COMMENT '订单内码',
  `FDate` varchar(24) DEFAULT NULL COMMENT '订单日期',
  `FSupplyID` varchar(11) DEFAULT NULL COMMENT '客户内码',
  `Fbusiness` varchar(11) DEFAULT NULL COMMENT '业务归属人',
  `FDeptID` int(11) NOT NULL COMMENT '部门内码',
  ...
  `profit` double(20,3) DEFAULT NULL COMMENT '毛利润',
  `weight` double DEFAULT NULL COMMENT '总净重',
  `transport_pay` double(20,3) DEFAULT NULL COMMENT '运输支出',
  `classify_pay` double(20,3) DEFAULT NULL COMMENT '分拣支出',
  `material_pay` double(20,3) DEFAULT NULL COMMENT '耗材支出',
  `total_pay` double DEFAULT NULL COMMENT '合计支出',
  KEY `FRelateBrID` (`FRelateBrID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trans_forcustomer_table` (
  ...
  `trash_weight` double DEFAULT NULL,
  `carbon_parmTal` double(20,3) DEFAULT NULL,
...
CREATE TABLE `trans_main_table` (
  ...
  `FDCStockID` varchar(12) DEFAULT NULL COMMENT '收入库房',
  `FSCStockID` varchar(12) DEFAULT NULL COMMENT '发出库房',
  ...
  `FSaleStyle` varchar(1) DEFAULT NULL COMMENT '销售方式   1--直销     2-销售',
  `FPOStyle` varchar(11) DEFAULT NULL COMMENT '结算方式',
  `FPOPrecent` varchar(11) DEFAULT NULL COMMENT '结算比例',
  ...
  KEY `IDX_FInterID_FTranType_FSalesStyle_FCancellation` (`FInterID`,`FTranType`,`FSaleStyle`,`FCancellation`) USING BTREE,
  KEY `IDX_FTranType_FCancellation` (`FTranType`,`FCancellation`) USING BTREE,
  KEY `IDX_FTranType_FinterID` (`FInterID`,`FTranType`,`FCancellation`,`FDCStockID`) USING BTREE,
  KEY `IDX_FCancellation` (`FInterID`,`FTranType`) USING BTREE,
  KEY `IDX_REPORT` (`FRelateBrID`,`FBillNo`,`FCancellation`,`FSaleStyle`,`FSupplyID`,`FEmpID`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `trans_materiel_table` (
  ...
  `red_ink_time` timestamp NULL DEFAULT NULL,
  `is_hedge` int(11) unsigned DEFAULT '0' COMMENT '是否为对冲数据 0否 1是',
...
CREATE TABLE `trans_month_sor_table` (
  `FRelateBrID` int(11) unsigned NOT NULL DEFAULT '0',
  `FInterID` varchar(11) DEFAULT NULL,
  `FDate` varchar(24) DEFAULT NULL,
  `FSupplyID` varchar(11) DEFAULT NULL,
  `Fbusiness` varchar(11) DEFAULT NULL,
  `FDeptID` int(11) NOT NULL,
  `FEmpID` int(11) unsigned DEFAULT NULL,
  `FPOStyle` varchar(11) DEFAULT NULL,
  `FPOPrecent` varchar(11) DEFAULT NULL,
  `profit` double(20,3) DEFAULT NULL,
  `weight` double DEFAULT NULL,
  `transport_pay` double(20,3) DEFAULT NULL,
  `classify_pay` double(20,3) DEFAULT NULL,
  `material_pay` double(20,3) DEFAULT NULL,
...
CREATE TABLE `trans_total_cargo_table` (
  `FInterID` int(11) unsigned NOT NULL DEFAULT '0',
  `FTranType` varchar(3) NOT NULL DEFAULT '',
  `FQtyTotal` double DEFAULT NULL,
  `FAmountTotal` double(19,2) DEFAULT NULL,
  `FSourceInterID` varchar(11) DEFAULT NULL,
  `FSourceTranType` varchar(3) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
CREATE TABLE `trans_total_fee_table` (
  `FInterID` int(11) unsigned NOT NULL DEFAULT '0',
  `FTranType` varchar(3) NOT NULL DEFAULT '',
  `CustomerProfit` varchar(19) NOT NULL DEFAULT '',
  `OtherProfit` varchar(19) NOT NULL DEFAULT '',
  `PickFee` varchar(19) NOT NULL DEFAULT '',
  `CarFee` varchar(19) NOT NULL DEFAULT '',
  `ManFee` varchar(19) NOT NULL DEFAULT '',
  `OtherReturnfee` varchar(19) NOT NULL DEFAULT '',
  `SortFee` varchar(19) NOT NULL DEFAULT '',
  `MaterielFee` varchar(19) NOT NULL DEFAULT '',
  `OtherSortfee` varchar(19) NOT NULL DEFAULT '',
  `SellProfit` varchar(19) NOT NULL DEFAULT '',
  `SellFee` varchar(19) NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `uct_accumulate_wall_report` (
  ...
  `weight` decimal(13,2) NOT NULL DEFAULT '0.00' COMMENT '采购重量',
  `availability` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '可利用率',
  `rubbish` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '低值废弃物产生量',
  `rdf` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT 'rdf排放量',
  `carbon` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '碳排放量',
...
CREATE TABLE `uct_actual_add_order` (
  ...
  PRIMARY KEY (`actual_log_id`,`order_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='实际销售订单标签表';
...
CREATE TABLE `uct_admin` (
  ...
  `old_cus_accid` varchar(100) DEFAULT '0' COMMENT '旧互客系统客户id',
  `old_link_accid` varchar(100) DEFAULT '0' COMMENT '旧互客系统客户联系人id',
...
CREATE TABLE `uct_admin_customer_mapping` (
  ...
  `up_customer_ids` text NOT NULL COMMENT '上游客户列表',
  `down_customer_ids` text NOT NULL COMMENT '下游客户列表',
...
CREATE TABLE `uct_apply_for_material_temp` (
  ...
  `meta_id` int(11) DEFAULT NULL COMMENT '辅料的id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='补录辅材的临时表';
CREATE TABLE `uct_apply_for_order_temp` (
  ...
  `metaID` int(11) DEFAULT NULL COMMENT '物料id',
  `net_weight` decimal(10,2) DEFAULT NULL COMMENT '修改后的净重',
  `price` decimal(10,2) DEFAULT NULL COMMENT '修改后的单价',
  `state` tinyint(2) DEFAULT NULL COMMENT '处理状态：0--未处理  1--处理完成   2--等待处理  3--其他情况',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='修改订单（修改红冲数据）的临时表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='权限分组表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='节点表';
...
CREATE TABLE `uct_auxy_material_warehouse` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='辅材的出入库表';
CREATE TABLE `uct_auxy_material_warehouse_detail` (
  ...
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='辅材出入库详情表';
...
CREATE TABLE `uct_auxy_material_warehouse_query` (
  ...
  `material_num` int(10) NOT NULL COMMENT '辅材数量',
  `dispose_time` int(10) DEFAULT NULL COMMENT '处置时间',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `uct_bas_line` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分拣线信息表  分拣线ID编码格式:          分部编号[二位缩写]+仓号[1~9 A~F]+线体编号[1~9 A~F]   例: BA11  宝安分部-1号仓-1号分拣线      LH12  龙华分部-1号仓-2号分拣线';
...
CREATE TABLE `uct_branch` (
  ...
  `accid` varchar(20) DEFAULT '0' COMMENT '互客系统id',
  ...
  `receivable_switch` tinyint(4) NOT NULL COMMENT '小额收款开关',
  ...
  `centre_warehouse_id` smallint(6) DEFAULT NULL COMMENT '中央仓储id',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分部表';
...
CREATE TABLE `uct_cate_account` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `uct_cate_account_idx_001` (`createtime`) USING BTREE,
  KEY `uct_cate_account_idx_002` (`cate_id`,`warehouse_id`,`branch_id`,`createtime`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `uct_centre_storage` (
  ...
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='仓库运营费存储表';
...
CREATE TABLE `uct_customer_annual_data` (
  ...
  `version` varchar(20) NOT NULL COMMENT '数据报告版本',
  `customer_id` int(11) NOT NULL COMMENT '客户ID',
  `data` json NOT NULL COMMENT '数据内容',
  `is_checkout` tinyint(4) NOT NULL DEFAULT '0' COMMENT '是否查看',
  `share_times` tinyint(4) NOT NULL DEFAULT '0' COMMENT '分享次数',
  `status` enum('enabled','disabled','unfollow') NOT NULL COMMENT '状态',
...
CREATE TABLE `uct_customer_report` (
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='月数据报表';
CREATE TABLE `uct_customer_report_memo` (
  ...
  `updata_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='月数据报表的描述表';
CREATE TABLE `uct_customer_servinfo` (
  ...
  `introduce_cn` varchar(100) NOT NULL COMMENT '中文介绍',
  `introduce_en` varchar(500) NOT NULL COMMENT '英文介绍',
  `img` text COMMENT '员工形象url',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='年度报告员工关联表';
CREATE TABLE `uct_day_wall_report` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `adcode` int(11) NOT NULL DEFAULT '0' COMMENT '区域行政编码 省 市 区',
  `weight` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '采购重量',
  `availability` decimal(5,2) NOT NULL DEFAULT '0.00' COMMENT '可利用率',
...
CREATE TABLE `uct_economic_circle` (
  ...
  `updata_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='经济圈板块';
CREATE TABLE `uct_economic_circle_branch` (
  ...
  `updata_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='经济圈板块对应的分部';
...
CREATE TABLE `uct_feedback` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='反馈内容记录表';
CREATE TABLE `uct_feedback_conf` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `conf_name` varchar(30) NOT NULL COMMENT '配置字段',
  `create_time` int(10) NOT NULL COMMENT '生成时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='反馈类型配置表';
...
CREATE TABLE `uct_hazardous_waste_admin` (
  ...
  `company_contact` varchar(50) DEFAULT NULL COMMENT '公司联系人',
  ...
  `apt_type` tinyint(1) DEFAULT NULL COMMENT '预约状态：0--初始状态  1--预约中  2--已确认  3--已取消',
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '确认预约时间',
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='危费六个页面的登录人员信息';
CREATE TABLE `uct_hazardous_waste_admin_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新环保管家的固废、危废预约的详情';
CREATE TABLE `uct_hazardous_waste_disposal` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='危废匹配（引导客户页面）';
CREATE TABLE `uct_hazardous_waste_env` (
  ...
  `updata_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='环境评估（引导客户页面）';
...
CREATE TABLE `uct_inventory_reconciliation` (
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='库存调账的主表';
CREATE TABLE `uct_inventory_reconciliation_detail` (
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='库存调账的详情表';
CREATE TABLE `uct_jobs_plan` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='工作计划表';
CREATE TABLE `uct_label` (
  ...
  `AW` int(11) DEFAULT '0' COMMENT '总重*100,使用整型保留两位小数',
  `NW` int(11) DEFAULT '0' COMMENT '净重*100,使用整型保留两位小数',
  `TW` int(11) DEFAULT '0' COMMENT '皮重*100,使用整型保留两位小数',
  `weight_unit` varchar(10) DEFAULT 'kg' COMMENT '重量单位',
  `price` int(11) DEFAULT '0' COMMENT '成交价格*1000,使用整形保留三位小数',
  ...
  PRIMARY KEY (`label_sn`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='有效订单表（运营月度看板使用）';
CREATE TABLE `uct_map` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='地图表';
CREATE TABLE `uct_materiel` (
  ...
  `updatetime` int(11) DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='辅材管理表';
...
CREATE TABLE `uct_materiel_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='辅材出入库日志';
CREATE TABLE `uct_modify_order_audit` (
  ...
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='改单表';
...
CREATE TABLE `uct_news_record` (
  ...
  `create_time` int(10) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='新闻信息记录表';
...
CREATE TABLE `uct_one_level_day_wall_report` (
  ...
  `weight` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '采购重量',
  `carbon` decimal(12,2) NOT NULL DEFAULT '0.00' COMMENT '碳排放',
...
CREATE TABLE `uct_order_bill` (
  ...
  `settle_type` tinyint(4) DEFAULT '1' COMMENT '1-现结，2-月结, 3-抵扣.4-现付+抵扣',
  `cash` double DEFAULT NULL COMMENT '现结金额',
  ...
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '状态  0/1',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='水单表';
CREATE TABLE `uct_order_cancel` (
  ...
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='订单取消';
...
CREATE TABLE `uct_purchase_sign_in_out` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建的时间',
  `update_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改的时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='操作员拉货签到和签退';
...
CREATE TABLE `uct_quotation_details` (
  ...
  `create_time` int(10) NOT NULL COMMENT '生成时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='报价项目表';
CREATE TABLE `uct_recycling_data` (
  ...
  `rfid` varchar(24) DEFAULT NULL COMMENT 'RFID',
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='移动箱体项目的箱体称重数据表';
CREATE TABLE `uct_recycling_log` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建的时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='移动收集箱体项目的路线和站点操作的日志表';
CREATE TABLE `uct_recycling_routes` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='移动收集箱体项目的路线表';
...
CREATE TABLE `uct_recycling_station` (
  ...
  `sales_weight` decimal(10,2) DEFAULT NULL COMMENT '销售总重',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='移动收集箱体项目的站点表';
...
CREATE TABLE `uct_review` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='废料评测主表';
CREATE TABLE `uct_review_audit` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='评测审核表';
CREATE TABLE `uct_review_auth` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='鉴定项目配置表';
CREATE TABLE `uct_review_details` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='评测的详情表';
CREATE TABLE `uct_sample_collect` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='废料评测的样品采集表';
CREATE TABLE `uct_sample_collect_details` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='废料评测的样品采集详情表';
...
CREATE TABLE `uct_sorting_commit` (
  ...
  `begin_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '开始时间',
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='分拣提交记录表,   1. 在什么位置     - 线体      - 工站    - 磅称 2. 是什么物    - 品类    - 包装ID    - 重量    - 单位 3. 是什么人    - 包装者    - 线长 4. 在什么时候    - 开始时间    - 结束时间 5. 是什么事     -提交分拣结果     -处理状态 ';
...
CREATE TABLE `uct_sorting_job_logs` (
  ...
  `update_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='批次分拣的历史记录表';
CREATE TABLE `uct_sorting_jobs` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='当前批次分拣表';
...
CREATE TABLE `uct_sorting_packings` (
  ...
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `update_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`package_no`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE `uct_sorting_task_template` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT=' 设置每个线体中各个磅秤物料的模板表';
CREATE TABLE `uct_sorting_task_template_detail` (
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='工位物料设置模板的详情表';
...
CREATE TABLE `uct_spi_customer_history` (
  ...
  `cust_type` varchar(20) DEFAULT 'up' COMMENT '客户类型:up=上游客户,down=下游客户',
  `star_level` int(11) DEFAULT '1' COMMENT '客户星级',
  `create_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `updated_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='客户上个月的星级';
CREATE TABLE `uct_spi_target` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IDX_dims` (`time_dims`,`time_val`,`data_dims`,`target_dims`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='绩效表';
...
CREATE TABLE `uct_voucher` (
  ...
  `collect_bank_account` varchar(50) DEFAULT '' COMMENT '到账银行账号',
  `account_num` varchar(50) DEFAULT '' COMMENT '客户银行账号',
  `bank` varchar(50) DEFAULT '' COMMENT '开户行(上游)',
  `bank_address` varchar(50) DEFAULT '' COMMENT '开户地址(上游)',
  ...
  `updatetime` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='预收付款申请记录表';
...
CREATE TABLE `uct_waste_cate` (
  ...
  `name` varchar(100) NOT NULL DEFAULT '' COMMENT '名称',
  `top_class` varchar(20) DEFAULT '' COMMENT '所属大类(null--初始状态  glass--玻璃   steel--钢铁 metal--有色金属  plastic--塑料    waste-paper--纸  semi-finished--半成品  wood--木材  comprehensive--综合类  material--辅材  basis--基础  waste--废弃物  other--其他类别)',
  `standard_price` float(10,2) DEFAULT '0.00' COMMENT '标准报价(元/kg)',
  `presell_price` float(10,3) DEFAULT '0.000' COMMENT '预提单价(元/kg)',
  `risk_cost` float(10,3) DEFAULT '0.000' COMMENT '风险成本(元/kg)',
  ...
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  `direction` int(11) DEFAULT NULL COMMENT '重定向品名',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `uct_waste_cate_actual` (
  ...
  `standard_value` float(10,3) DEFAULT NULL COMMENT '标准销售报价',
...
CREATE TABLE `uct_waste_cate_actual_log` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `IDX_id_branch_id` (`id`,`branch_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
CREATE TABLE `uct_waste_cate_actual_log_item` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `cate_id_customer_id` (`cate_id`,`customer_id`) USING BTREE,
  KEY `IDX_state_start_time` (`actual_log_id`,`state`,`start_time`) USING BTREE,
  KEY `IDX_branch_state_start_time` (`branch_id`,`state`,`start_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
CREATE TABLE `uct_waste_cate_bak` (
  ...
  `presell_price` float(10,3) DEFAULT '0.000' COMMENT '预提单价(元/kg)',
  `risk_cost` float(10,3) DEFAULT NULL COMMENT '风险成本(元/kg)',
  `image` varchar(100) DEFAULT NULL COMMENT '图片',
  `value_type` varchar(20) DEFAULT 'valuable' COMMENT '价值类型  valuable有价  unvaluable 无价',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  `state` enum('1','0') NOT NULL DEFAULT '1' COMMENT '状态:1=启用,0=禁用',
...
CREATE TABLE `uct_waste_cate_expect_log` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='预提销售单价';
CREATE TABLE `uct_waste_cate_log` (
  ...
  `value` varchar(20) DEFAULT '0.000' COMMENT '变化后的值',
...
CREATE TABLE `uct_waste_cate_overdue` (
  ...
  `updata_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='需要查询的超期品类表（仓库指标月度看板使用）';
CREATE TABLE `uct_waste_customer` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `cus_accid` varchar(100) NOT NULL DEFAULT '0' COMMENT '互客系统id',
  `old_cus_accid` varchar(100) NOT NULL DEFAULT '0' COMMENT '老互客系统id',
  `crmid` varchar(100) NOT NULL DEFAULT '0' COMMENT 'crmid',
  `admin_id` varchar(100) DEFAULT NULL COMMENT '客户账号ID',
  `branch_id` int(10) unsigned DEFAULT NULL COMMENT '分部ID',
  `internal` tinyint(3) unsigned DEFAULT '0' COMMENT '内部客户 0否 1是',
  ...
  `agre_expire` varchar(20) DEFAULT '' COMMENT '合同到期时间',
  `sign_company` varchar(100) NOT NULL DEFAULT '' COMMENT '签约公司',
  `print_title_id` int(11) NOT NULL DEFAULT '0' COMMENT '打印抬头id',
  `name_en` varchar(100) NOT NULL DEFAULT '' COMMENT '企业全称(英文)',
  `allot_id` int(11) NOT NULL DEFAULT '0' COMMENT '指定分配人',
  ...
  `back_percent` int(10) unsigned DEFAULT '999' COMMENT '分成比例(%)',
  `black_state` int(10) unsigned DEFAULT '0' COMMENT '重点关注客户',
  `state` enum('black','consult','draft','enabled') NOT NULL DEFAULT 'draft' COMMENT '状态:black=黑名单,consult=客户咨询,draft=草稿,enabled=已提交',
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `customer_type_state` (`customer_type`,`state`) USING BTREE
...
CREATE TABLE `uct_waste_customer_factory` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='客户工厂表';
...
CREATE TABLE `uct_waste_customer_gathering` (
  ...
  `receiver` varchar(50) DEFAULT '' COMMENT '收款人',
  `bank_account` varchar(50) DEFAULT '' COMMENT '银行账号',
  `deposit_bank` varchar(100) DEFAULT '' COMMENT '开户银行',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='客户收款信息表';
CREATE TABLE `uct_waste_customer_linkman` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='客户联系人表';
CREATE TABLE `uct_waste_customer_log` (
  ...
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='客户状态记录表';
CREATE TABLE `uct_waste_evaluate` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='废料评测表';
CREATE TABLE `uct_waste_hazardous_cate` (
  ...
  `create_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='危废的名称';
...
CREATE TABLE `uct_waste_purchase` (
  ...
  `cargo_pick_date` date DEFAULT NULL COMMENT '提货日期',
  ...
  `train_number` float(10,2) unsigned DEFAULT '1.00' COMMENT '车次',
  ...
  `cargo_price` float(20,3) DEFAULT NULL COMMENT '货品费用(元)',
  ...
  `is_sorting` tinyint(1) unsigned DEFAULT '0' COMMENT '是否上分拣线:1=是,0=否',
  ...
  `is_evaluate_data` enum('1','0') DEFAULT NULL COMMENT '是否已评价:1=是,0=否',
  `sort_point` int(10) unsigned DEFAULT NULL COMMENT '分拣点',
  `storage_price` float(10,2) DEFAULT NULL COMMENT '入库费用(元)',
  ...
  `storage_cargo_price` float(20,3) DEFAULT NULL COMMENT '入库净重价钱',
  ...
  `state` enum('draft','wait_allot','wait_receive_order','wait_apply_materiel','wait_pick_materiel','wait_signin_materiel','wait_pick_cargo','wait_pay','wait_storage_connect','wait_storage_connect_confirm','wait_storage_sort','wait_storage_confirm','wait_return_fee','wait_confirm_return_fee','finish','cancel') NOT NULL DEFAULT 'draft' COMMENT '状态:draft=草稿,wait_allot=待分配,wait_receive_order=待接单,wait_apply_materiel=待申请辅材,wait_pick_materiel=待提取辅材,wait_signin_materiel=待签收辅材,wait_pick_cargo=待提货,wait_pay=待付款,wait_storage_connect=待入库交接,wait_storage_connect_confirm=待确认交接,wait_storage_sort=待分拣入库,wait_storage_confirm=待入库确认,wait_confirm_return_fee=待审核订单,finish=交易完成',
  ...
  `prop_ratio` decimal(10,3) NOT NULL DEFAULT '0.000',
  `print_num` int(11) NOT NULL DEFAULT '0' COMMENT '打印次数',
  `forensics_time` int(11) DEFAULT NULL COMMENT '取证的时间',
  ...
  KEY `idx_state` (`state`,`createtime`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购订单表';
CREATE TABLE `uct_waste_purchase_cargo` (
  ...
  `storage_net_weight` float unsigned DEFAULT NULL COMMENT '入库净重(kg)',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购货品表';
CREATE TABLE `uct_waste_purchase_evaluate` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `purchase_id` (`purchase_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购评价表';
CREATE TABLE `uct_waste_purchase_expense` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购开支表';
CREATE TABLE `uct_waste_purchase_log` (
  ...
  KEY `purchase_id_2` (`purchase_id`,`state_value`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购状态记录表';
CREATE TABLE `uct_waste_purchase_materiel` (
  ...
  `inside_price` float(19,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '内部销售价',
  `pick_amount` int(10) unsigned DEFAULT '0' COMMENT '出库数量',
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `purchase_materiel_t_idx_001` (`purchase_id`,`pick_amount`,`storage_amount`,`inside_price`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='采购订单辅材表';
CREATE TABLE `uct_waste_quote_prices_table` (
  ...
  `update_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='报价行情指数表';
CREATE TABLE `uct_waste_report` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='评测报告表';
CREATE TABLE `uct_waste_report_log` (
  ...
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='评测报告状态记录表';
CREATE TABLE `uct_waste_sell` (
  ...
  UNIQUE KEY `order_id` (`order_id`) USING BTREE,
  KEY `branch_id` (`branch_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售订单表';
CREATE TABLE `uct_waste_sell_cargo` (
  ...
  `rough_weight` float unsigned DEFAULT NULL COMMENT '出货皮重(kg)',
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售货品表';
CREATE TABLE `uct_waste_sell_customer_evaluate` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售订单客户评价表';
CREATE TABLE `uct_waste_sell_evidence_voucher` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='销售付款凭证记录表';
CREATE TABLE `uct_waste_sell_log` (
  ...
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售状态记录表';
CREATE TABLE `uct_waste_sell_materiel` (
  ...
  `unit_price` float(10,2) DEFAULT NULL COMMENT '单价(元/kg)',
  `materiel_number` text COMMENT '物料编码',
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售订单辅材表';
CREATE TABLE `uct_waste_sell_other_price` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `sell_id` int(10) unsigned NOT NULL COMMENT '销售ID',
  `type` enum('in','out','inout') DEFAULT NULL COMMENT '类型:in=收入,out=支出,inout下游指出',
  `usage` varchar(50) NOT NULL DEFAULT '' COMMENT '用途',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `price` float(10,2) NOT NULL DEFAULT '0.00' COMMENT '价格(元)',
  `receiver` varchar(50) NOT NULL DEFAULT '' COMMENT '领款人',
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售订单其他费用表';
CREATE TABLE `uct_waste_sell_seller_evaluate` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='销售订单销售评价表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='废料配置表';
CREATE TABLE `uct_waste_storage` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `branch_id` int(10) unsigned NOT NULL COMMENT '分部ID',
  `cate_id` int(10) unsigned NOT NULL COMMENT '废料分类ID',
  `origin_storage` float NOT NULL DEFAULT '0' COMMENT '期初库存(kg)',
  `storage_weight` float NOT NULL DEFAULT '0' COMMENT '库存总重(kg)',
  `purchase_price` float(10,2) NOT NULL DEFAULT '0.00' COMMENT '回收均价(元)',
  `recent_sell_weight` float unsigned NOT NULL DEFAULT '0' COMMENT '最近出货量(kg)',
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='库存信息表';
CREATE TABLE `uct_waste_storage_audit` (
  ...
  `updata_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='数据员进销存审批物料详情 （入库数据差异的审批）  详情表';
CREATE TABLE `uct_waste_storage_expense` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='入库费用表';
CREATE TABLE `uct_waste_storage_log` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `admin_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '操作者ID',
  `cate_id` int(10) unsigned NOT NULL COMMENT '废料分类ID',
  `type` enum('origin_storage','storage_weight') NOT NULL COMMENT '类型:origin_storage=期初库存,storage_weight=库存重量',
  `change` float(10,2) DEFAULT NULL COMMENT '变化值',
  `value` float(10,2) DEFAULT NULL COMMENT '变化后的值',
  `ip` varchar(50) NOT NULL DEFAULT '' COMMENT '操作者IP',
  `createtime` int(10) unsigned DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='库存记录表';
CREATE TABLE `uct_waste_storage_return_fee` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `storage_return_fee_t_idx_001` (`purchase_id`,`price`,`usage`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='入库报销表';
CREATE TABLE `uct_waste_storage_sort` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `purchase_id` int(10) unsigned NOT NULL COMMENT '采购ID',
  `remark` varchar(255) NOT NULL DEFAULT '' COMMENT '货品分拣备注',
  `cargo_sort` int(10) unsigned DEFAULT NULL COMMENT '入库分类',
  `materiel_number` varchar(50) NOT NULL DEFAULT '' COMMENT '物料编码',
  `total_weight` float unsigned DEFAULT NULL COMMENT '总重(kg)',
  `rough_weight` float unsigned DEFAULT NULL COMMENT '毛重(kg)',
  `net_weight` float unsigned DEFAULT NULL COMMENT '净重(kg)',
  `presell_price` float(10,3) DEFAULT NULL COMMENT '预提销售单价(元/kg)',
  `disposal_way` varchar(20) DEFAULT 'sorting' COMMENT '处理方式: [sorting  分拣 / weighing  过磅]',
  `value_type` varchar(20) DEFAULT 'valuable' COMMENT '价值类型  valuable有价  unvaluable 无价',
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='分拣入库表';
...
CREATE TABLE `uct_waste_storage_sort_expense` (
  ...
  `updatetime` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  KEY `storage_sort_expense_t_idx_001` (`purchase_id`,`price`,`usage`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='分拣费用表';
...
CREATE TABLE `uct_wechat_applet` (
  ...
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT COMMENT='微应用表';
