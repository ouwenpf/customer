...
DROP PROCEDURE IF EXISTS "test_lvhuan"."lh_dw_month_report_by_cust_mysql";

-- 创建名为 "lh_dw_month_report_by_cust" 的存储过程
CREATE OR REPLACE PROCEDURE "test_lvhuan"."lh_dw_month_report_by_cust_mysql"(
    IN "p_day" VARCHAR(50),
    IN "p_cust_id" INTEGER,
    INOUT "io_rv" INTEGER,
...
-- 删除名为 "lh_dw_month_report_by_cust" 的存储过程
DROP PROCEDURE IF EXISTS "test_lvhuan"."lh_dw_month_report_by_cust"(VARCHAR(50), INT, INOUT INTEGER, INOUT VARCHAR(200));

-- 创建名为 "lh_dw_month_report_by_cust" 的存储过程
CREATE OR REPLACE PROCEDURE "test_lvhuan"."lh_dw_month_report_by_cust"(IN "p_day" VARCHAR(50), IN "p_cust_id" INT, INOUT io_rv INTEGER, INOUT io_err VARCHAR(200))
LANGUAGE plpgsql AS $$
DECLARE
    v_new_day VARCHAR(50);
BEGIN
...
END;
$$;
DROP PROCEDURE IF EXISTS "test_lvhuan"."lh_dw_month_report_mysql_new";

CREATE OR REPLACE PROCEDURE "test_lvhuan"."lh_dw_month_report_mysql_new"(
    IN "p_day" VARCHAR(50),
    INOUT "o_rv_err" VARCHAR(200)
)
LANGUAGE plpgsql AS $$
